...
\begin{figure}[t]
    ...
    \hspace*{0.3cm}\subfloat[][]{\includegraphics[trim={0.3cm 0.35cm 0.8cm 0.3cm},clip,height=4cm]{python/simulation_2/plots/NPM_over_time_M8.png}\label{fig:perf_eval:NPM_over_time_M8}}
    \vspace*{-0.2cm}
